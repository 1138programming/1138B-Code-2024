...
class Arm {
    ...
    public:
        Arm(pros::Motor armMotor1, lemlib::PID armPID, float stowPos, float readyPos, float scorePos, float allianceScorePos, float mogoTiltPos, float mogoUntiltPos, float gearRatio);
        enum States {
            STOW,
            READY,
            SCORE,
